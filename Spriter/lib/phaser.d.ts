...
declare module Phaser {
    ...
    class Pointer {
        ...
        isMouse: boolean;
        isUp: boolean;
        leftButton: Phaser.DeviceButton; // boolean;
        middleButton: Phaser.DeviceButton;  // boolean;
        movementX: number;
        movementY: number;
        ...
        rawMovementX: number;
        rawMovementY: number;
        rightButton: Phaser.DeviceButton; // boolean;
        screenX: number;
        screenY: number;
        target: any;
        targetObject: any;
    ...
    class DeviceButton {
        ...
        constructor(parent: Phaser.Pointer | Phaser.SinglePad, buttonCode: number)
        ...
        start(event: any, value: number): void;
        stop(event: any, value: number): void;
